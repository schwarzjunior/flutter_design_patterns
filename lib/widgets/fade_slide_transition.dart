...
class FadeSlideTransition extends StatelessWidget {
  ...
  double get _begin => index != null && singleItemDurationInterval != null ? _calculateBegin() : begin;

  double get _end => index != null && singleItemDurationInterval != null ? _calculateEnd() : end;

  double _calculateBegin() {
    var delay = (singleItemDurationInterval * index).toDouble();

    return begin + delay < 1.0 ? begin + delay : 1.0 - singleItemDurationInterval;
  }
